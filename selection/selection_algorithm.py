...
class SelectionAlgorithm:
    ...
    def calculate_best_indexes_with_maintenance_constraint(self, workload, candidate_indexes, maintenance_cost):
        assert self.did_run is False, "Selection algorithm can only run once."
        self.did_run = True
        indexes = self._calculate_best_indexes_with_maintenance_constraint(workload)
        self._log_cache_hits()
        self.cost_evaluation.complete_cost_estimation()
